...
Page({
    ...
    wx.getLocation({
      ...
      success(res) {
        ...
        var lat = res.latitude,
            lng = res.longitude
        wx.request({
          url: 'https://ps.dyj168888.com/api/peisong/position',
          data:{
      ...
      wx.showModal({
        ...
        success(res) {
          ...
          if (res.confirm) {
            ...
            wx.request({
              url: 'https://ps.dyj168888.com/api/peisong_login/status',
              data:{
                member_id: wx.getStorageSync("member_id"),
  ...
  getInfo:function(){
    var that =this;
    wx.request({
      url: 'https://ps.dyj168888.com/api/peisong/order_list',
      data: {
        member_id: wx.getStorageSync("member_id"),
  ...
  setOrderStatus(e){
    ...
    switch(type){
      case 1://抢单
        ...
        wx.request({
          url: 'https://ps.dyj168888.com/api/peisong/robbing',
          data:data,
          success(res){
            console.log(res)
        ...
        wx.showModal({
          ...
          success(res){
            if (res.confirm){
              ...
              wx.request({
                url: 'https://ps.dyj168888.com/api/peisong/complete_meal',
                data:data,
                success(res){
                  console.log(res)
                  if(res.data.code==200){
            ...
            if (res.confirm){
              wx.getLocation({
                ...
                success: function(res) {
                  ...
                  wx.request({
                    url: 'https://ps.dyj168888.com/api/peisong/complete_order',
                    data:data,
                    success(res){
                      console.log(res)
                      if(res.data.code==200){
  ...
  getState(callback){
    var that=this;
    wx.request({
      url: 'https://ps.dyj168888.com/api/peisong/before_order',
      data:{
        member_id: wx.getStorageSync("member_id")
      },
      header: {
  ...
  getqState: function () {
    ...
    var that = this;
    wx.request({
      url: 'https://ps.dyj168888.com/api/peisong/status',
      data: {
        member_id: wx.getStorageSync("member_id"),
      },
      header: {
