...
Page({
  ...
  toLogin(tel, pass){
    var that=this;
    wx.request({
      url: 'https://ps.dyj168888.com/api/peisong_login/login',
      data: {
  ...
  sevenFree:function(){
    wx.request({
      url: 'https://ps.dyj168888.com/api/peisong_login/memberCache',
      data:{
    ...
    var that =this;
      wx.login({
        success(res){
          console.log(res)
          wx.request({
            url: 'https://ps.dyj168888.com/api/peisong_login/WxLogin',
            data:{
              code: res.code,
