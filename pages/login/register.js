...
Page({
    ...
    //图片上传
      wx.chooseImage({
        success(res) {
          ...
          wx.uploadFile({
            url: 'https://ps.dyj168888.com/api/Upload/upload', 
  ...
  submit(e){
    ...
    wx.request({
      url: 'https://ps.dyj168888.com/api/peisong_login/registered',
      data: data,
      header: {
  ...
  getVerification(){
    ...
    wx.request({
      url: 'https://ps.dyj168888.com/api/peisong_login/sendSms',
      data:{
  ...
  getImg(){
    var that =this;
    wx.request({
      url: 'https://ps.dyj168888.com/api/peisong_login/code',
      data: {
